...
int playAmbassador(int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int currentPlayer)
{
    ...
    {
        if (i == currentPlayer) // used to be i != currentPlayer
        {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        return playMine(choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
    ...
    case baron:
        return playBaron(choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
    ...
    case minion:
        return playMinion(choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
    ...
    case tribute:
        return playTribute(choice1, choice2, choice3, state, handPos, bonus, currentPlayer, nextPlayer);

    case ambassador:
        return playAmbassador(choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
